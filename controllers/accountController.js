...
async function buildManagement(req, res, next) {
  ...
  jwt.verify(
    ...
    async (err, accountData) => {
      ...
      // Fetch full user data from the database (to get account type)
      ...
      res.render("account/account", {
        ...
        nav,
        accountData: fullAccountData, // Pass user data for rendering
      });
    }
  );
}
...
async function logout(req, res) {
  res.clearCookie("jwt"); // Remove authentication token
